  ...
  <el-main>
    <el-form :inline="true" :model="queryForm" class="demo-form-inline">
      ...
      <el-form-item label="年龄">
        <el-input v-model="queryForm.ageStart" clearable placeholder="年龄"></el-input>
      </el-form-item>
      <el-form-item label="到">
        <el-input v-model="queryForm.ageEnd" clearable placeholder="年龄"></el-input>
      </el-form-item>
      <el-form-item>
    ...
    <el-pagination :page-count="pages" @current-change="goToPage" layout="prev, pager, next"></el-pagination>
    ...
    <el-dialog title="提示" :visible.sync="dialogVisible" width="60%">
      <el-form :inline="true" :model="saveForm" class="demo-form-inline">
        ...
        <el-form-item label="省">
          <el-select v-model="saveForm.province_id" @change="changeCity" placeholder="请选择省">
            <el-option
...
<script>
  ...
  export default {
    ...
    methods: {
      handleAvatarSuccess(res, file) {
        ...
        if (fileName != null) {
          ...
          axios({
            ...
            console.log("返回值是:" + res.data.result);
            if (res.data.result) {
              console.log("文件已经删除");
            } else {
              console.log("文件删除失败");
      ...
      changeCity() {
        let self = this;
        let pid = this.saveForm.province_id;
        axios({
    ...
    created() {
      ...
      axios({
        ...
        self.provinceList = res.data.privinceList;
